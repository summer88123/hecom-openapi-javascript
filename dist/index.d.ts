...
/** 主子业务数据请求 */
export declare interface DataWithRelatedRequest {
    /** 主对象数据 */
...
/** 主子业务数据响应 */
export declare interface DataWithRelatedResponse {
    /** 主数据id */
    code: string;
    /** 子数据id列表 */
    relatedCodes: string[];
...
/** 关联子对象数据 */
export declare interface RelatedData {
    /** 子对象名称 */
    apiName: string;
    /** 主对象在子对象中所占用的字段的名称 */
    refFieldName: string;
...
/** 树形子数据集合 */
export declare interface TreeRecordItem {
    /** 树形子数据集合 */
    records: TreeRecord[];
}

/** 关联的树形子对象数据 */
export declare interface TreeRelatedData {
    /** 树形子对象的ApiName */
    apiName: string;
    /** 主对象在树形子对象中所占用的字段的名称 */
    refFieldName: string;
